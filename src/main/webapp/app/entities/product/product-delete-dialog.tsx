...
export const ProductDeleteDialog = (props: IProductDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.product.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.product.delete.question" interpolate={{ id: productEntity.id }}>
