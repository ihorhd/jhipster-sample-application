              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('productName')}>
                    <Translate contentKey="jhipsterSampleApplicationApp.product.productName">Product Name</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jhipsterSampleApplicationApp.product.source">Source</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {productList.map((product, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{product.source ? <Link to={`source/${product.source.id}`}>{product.source.id}</Link> : ''}</td>
