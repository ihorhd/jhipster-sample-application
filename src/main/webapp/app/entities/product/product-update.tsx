...
export const ProductUpdate = (props: IProductUpdateProps) => {
  ...
  const { productEntity, sources, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.product.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="product-source">
                  <Translate contentKey="jhipsterSampleApplicationApp.product.source">Source</Translate>
                </Label>
                <AvInput id="product-source" type="select" className="form-control" name="source.id">
                  <option value="" key="0" />
                  {sources
